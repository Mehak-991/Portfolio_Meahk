...
const EXPERIENCE = [
  {
    ...
    bullets: [
      ...
      "Developed and evaluated machine learning pipelines, optimizing feature selection and model performance to improve prediction reliability and business outcomes.",
      "Collaborated on real-world data-driven projects, applying statistical analysis and visualization techniques to uncover trends and support informed decision-making.",
    ],
    tags: ["Python", "Machine Learning", "EDA", "Predictive Analysis", "Scikit-Learn", "Feature Engineering", " Data visualization"],
  },
  {
    ...
    bullets: [
      ...
      "Developed predictive modeling workflows and feature engineering strategies to improve data quality, model interpretability, and overall analytical performance.",
      "Presented data-driven findings through interactive visualizations and reports, enabling stakeholders to identify trends and make informed business decisions.",
    ],
